...
import { BsArrowUp, BsInstagram, BsFillTelephoneFill, BsTwitter } from 'react-icons/bs';
      ...
      <div  className='h-screen bg-gradient-to-r from-blue-900 to-gray-900 scroll-smooth' id='introduction'>
        ...
        <div className='h-screen w-full bg-gray-700' id='contact'>
          ...
          <ul className='pt-5 text-2xl flex flex-col items-center justify-center  w-40 mx-auto'>
            <li > <a className='flex items-center justify-between' target="_blank" href="https://www.instagram.com/sonio_deji"><BsInstagram />     Instagram</a></li>
              <li className='pt-5'><a className='flex items-center justify-between' target="_blank" href="https://twitter.com/sonio_deji"><BsTwitter />Twitter</a></li>
              <li className='pt-5' ><a target="_blank" href="mailto:atandauthman2@gmail.com">@send a mail</a></li>
              <li className='pt-5'><a className='flex items-center justify-between' target="_blank" href="tel:+243-811-773-0982"><BsFillTelephoneFill />Call ME</a></li>
          </ul>
        </div>
          </div>
       ...
       >
        ...
        >
          <div className='fixed top-0 right-0 float-right pr-4'  onClick={() => setmenu(false)}>
            ...
            className=' cursor-pointer' width="30" height="20" viewBox="0 0 24 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M24 4H0V0H24V4ZM24 8H0V12H24V8ZM24 16H0V20H24V16Z" fill="white"/>
            </motion.svg>
            </div>
        {
