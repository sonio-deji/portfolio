            ...
            <div className='flex flex-col max-w-screen-lg mx-auto gap-4 lg:grid grid-cols-2'>
                {
                  projects.map(({title, id, address}) => (
                    <motion.a whileHover={{scale: 1.1}} target='_blank' rel='noreferrer' href={address} key={id} className='w-fit mx-auto rounded-lg p-4 text-center border cursor-pointer border-gray-600'>
